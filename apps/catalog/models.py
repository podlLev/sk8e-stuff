...
class Image(models.Model):
    ...
    def image_tag_thumbnail(self):
        if self.image:
            ...
            return mark_safe(f"<img src='/{MEDIA_ROOT}{self.image_thumbnail}' width='150'>")
...
class Product(MetaTagMixin):
    ...
    user = models.ForeignKey(to=User, verbose_name='Владелец', null=True, blank=True, on_delete=models.CASCADE)
